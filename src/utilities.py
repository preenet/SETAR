...
if __name__ == "__main__":
    config = read_config()
    #generate_report_10repeated_baseline('POS_TAG_TO', '12classifier_POSMEAN_(1, 1)_to.csv')
    generate_report_10repeated_deepbaseline('/BASELINE/BLSTM_KT', 'blstm_10repeated_kt_final.csv')
