...
clfs = StackingClassifier(estimators=level0, final_estimator=make_pipeline(MaxAbsScaler(), svc), cv=5, n_jobs=-1)
...
clfs = StackingClassifier(estimators=level0, final_estimator=make_pipeline(MaxAbsScaler(), rf), cv=5, n_jobs=-1)
level1 =  GridSearchCV(estimator=clfs, param_grid=grid_param, cv=5, n_jobs=-1)
level1.fit(X, y)
best_clf = level1.best_estimator_
acc, sens, spec, mcc, roc, f1 = test(best_clf,X,y,Xv,yv)
...
clfs = StackingClassifier(estimators=level0, final_estimator=make_pipeline(MaxAbsScaler(), et), cv=5, n_jobs=-1)
level1 =  GridSearchCV(estimator=clfs, param_grid=grid_param, cv=5, n_jobs=-1)
level1.fit(X, y)
best_clf = level1.best_estimator_
acc, sens, spec, mcc, roc, f1 = test(best_clf,X,y,Xv,yv)
...
clfs = StackingClassifier(estimators=level0, final_estimator=make_pipeline(MaxAbsScaler(), xgb), cv=5, n_jobs=-1)
level1 =  GridSearchCV(estimator=clfs, param_grid=grid_param, cv=5, n_jobs=-1)
level1.fit(X, y)
best_clf = level1.best_estimator_
acc, sens, spec, mcc, roc, f1 = test(best_clf,X,y,Xv,yv)
...
clfs = StackingClassifier(estimators=level0, final_estimator=make_pipeline(MaxAbsScaler(), lgbm), cv=5, n_jobs=-1)
level1 =  GridSearchCV(estimator=clfs, param_grid=grid_param, cv=5, n_jobs=-1)
level1.fit(X, y)
best_clf = level1.best_estimator_
acc, sens, spec, mcc, roc, f1 = test(best_clf,X,y,Xv,yv)
...
clfs = StackingClassifier(estimators=level0, final_estimator=make_pipeline(MaxAbsScaler(), mlp), cv=5, n_jobs=-1)
level1 =  GridSearchCV(estimator=clfs, param_grid=grid_param, cv=5, n_jobs=-1)
level1.fit(X, y)
best_clf = level1.best_estimator_
acc, sens, spec, mcc, roc, f1 = test(best_clf,X,y,Xv,yv)
...
level0 = get_stacking()
nb = GaussianNB()
clfs = StackingClassifier(estimators=level0, final_estimator=make_pipeline(MaxAbsScaler(), nb), cv=5, n_jobs=-1)
level1 =  GridSearchCV(estimator=clfs, param_grid=grid_param, cv=5, n_jobs=-1)
level1.fit(X, y)
best_clf = level1.best_estimator_
...
clfs = StackingClassifier(estimators=level0, final_estimator=make_pipeline(MaxAbsScaler(), knn), cv=5, n_jobs=-1)
level1 =  GridSearchCV(estimator=clfs, param_grid=grid_param, cv=5, n_jobs=-1)
level1.fit(X, y)
best_clf = level1.best_estimator_
acc, sens, spec, mcc, roc, f1 = test(best_clf,X,y,Xv,yv)
...
clfs = StackingClassifier(estimators=level0, final_estimator=make_pipeline(MaxAbsScaler(), dt), cv=5, n_jobs=-1)
level1 =  GridSearchCV(estimator=clfs, param_grid=grid_param, cv=5, n_jobs=-1)
level1.fit(X, y)
best_clf = level1.best_estimator_
acc, sens, spec, mcc, roc, f1 = test(best_clf,X,y,Xv,yv)
...
clfs = StackingClassifier(estimators=level0, final_estimator=make_pipeline(MaxAbsScaler(), lr), cv=5, n_jobs=-1)
level1 =  GridSearchCV(estimator=clfs, param_grid=grid_param, cv=5, n_jobs=-1)
level1.fit(X, y)
best_clf = level1.best_estimator_
acc, sens, spec, mcc, roc, f1 = test(best_clf,X,y,Xv,yv)
...
clfs = StackingClassifier(estimators=level0, final_estimator=make_pipeline(MaxAbsScaler(), pls), cv=5, n_jobs=-1)
level1 =  GridSearchCV(estimator=clfs, param_grid=grid_param, cv=5, n_jobs=-1)
level1.fit(X, y)
best_clf = level1.best_estimator_
acc, sens, spec, mcc, roc, f1 = test(best_clf,X,y,Xv,yv)
